...
const noticesQuery = useQuery((api as any).notices.overview, { classId: data.klass._id }, () => ({
	...
	<div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
		...
		<div class="sm:col-span-1 mb-6">
			<div class="flex items-center justify-between mb-2.5">
				...
				<a href="{base}/timetable" class="text-sm text-neutral-400 dark:text-neutral-500 hover:text-neutral-600 dark:hover:text-neutral-300 transition-colors duration-100">모두 보기 →</a>
			</div>
	...
	<div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
		...
		<div class="mb-6">
			<div class="flex items-center justify-between mb-2.5">
				...
				<a href="{base}/notices" class="text-sm text-neutral-400 dark:text-neutral-500 hover:text-neutral-600 dark:hover:text-neutral-300 transition-colors duration-100">모두 보기 →</a>
			</div>
